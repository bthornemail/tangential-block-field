...
The Blackboard Field is not a shared memory object, a database, or a globally materialized table [0x01.1]. It is a bounded projective field ($\mathbb{B} = (P_B, S, \Gamma)$) in which otherwise independent relational blocks become jointly visible [0x01.1, 0x01.3].
